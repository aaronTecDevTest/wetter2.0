 ...
 * @author a.kutekidila
 */
public class TC2700_Reihenfolge_der_Suchbegriffe extends GenericTest_New {
    ...
    public void runTest() {
        ...
        globalVar.searchStringList.add("Darmstadt Arheiligen");
    ...
    public static void main(String[] args) {
        TC2700_Reihenfolge_der_Suchbegriffe test = new TC2700_Reihenfolge_der_Suchbegriffe();
        test.before();
        test.runTest();
        test.after();
    }

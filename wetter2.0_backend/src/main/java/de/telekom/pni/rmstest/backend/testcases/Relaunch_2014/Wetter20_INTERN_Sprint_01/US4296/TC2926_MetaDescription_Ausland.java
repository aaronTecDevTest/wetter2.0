 ...
 * @author a.kutekidila
 */
public class TC2926_MetaDescription_Ausland extends GenericTest_New {
     ...
     *
     */
    public TC2926_MetaDescription_Ausland() {
    ...
    public void runTest() {
        ...
        try {
            for (int i = 0; i < 1; i++) {
                ...
                if (checkTitle(globalVar.searchStringList.get(i), globalVar.resultStringList.get(i), kreis.get(i))) {
    ...
    public static void main(String[] args) {
        TC2926_MetaDescription_Ausland test = new TC2926_MetaDescription_Ausland();
        test.before();
        test.runTest();
        test.after();

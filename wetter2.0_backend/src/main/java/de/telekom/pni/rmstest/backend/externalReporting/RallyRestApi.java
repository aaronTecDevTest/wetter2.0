...
public class RallyRestApi implements Closeable {
     ...
     */
    public static final String DEFAULT_WSAPI_VERSION = "1.43";
     ...
     */
    public RallyRestApi(URI server, String userName, String password) throws NoSuchAlgorithmException, KeyManagementException {

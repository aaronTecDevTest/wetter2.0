 ...
 * @author a.kutekidila
 */
public class TC2696_Mallorca_Matchen_mit_nicht_komplette_Begriffe extends GenericTest_New {
    ...
    public void runTest() {
        ...
        globalVar.searchStringList.add("allorca");
        ...
        globalVar.resultStringList.add("Alloca (Peru, Lima)");
        globalVar.resultStringList.add("Allora (Australien, Queensland)");
    ...
    public static void main(String[] args) {
        TC2696_Mallorca_Matchen_mit_nicht_komplette_Begriffe test = new TC2696_Mallorca_Matchen_mit_nicht_komplette_Begriffe();
        test.before();
        test.runTest();
        test.after();
    }

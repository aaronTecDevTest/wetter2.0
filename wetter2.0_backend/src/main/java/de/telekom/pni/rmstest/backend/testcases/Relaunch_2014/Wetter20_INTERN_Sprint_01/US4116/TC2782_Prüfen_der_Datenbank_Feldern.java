 ...
 *
 */
package de.telekom.pni.rmstest.backend.testcases.Relaunch_2014.Wetter20_INTERN_Sprint_01.US4116;
 ...
 * @author a.kutekidila
 */
public class TC2782_Prüfen_der_Datenbank_Feldern extends GenericTest_New {
    ...
    public void runTest() {
        ...
        //this.getBrowser();
        //Step 2
        this.navigate("http://suche.wetter.info/ariadne/wsuggestion?location=new&limitNumber=10&limitCountries=??&countryPriority=?");
        this.pauseTest(2000);

        //Step 3 to ??
        List<WebElement> dataBaseFelds = getWebElements(".//*[@id='json']/ul/li[3]/ul/li/ul/li[1]/ul/li[*]/span[1]");
    ...
    public static void main(String[] args) {
        TC2782_Prüfen_der_Datenbank_Feldern test = new TC2782_Prüfen_der_Datenbank_Feldern();
        test.before();
        test.runTest();
        test.after();

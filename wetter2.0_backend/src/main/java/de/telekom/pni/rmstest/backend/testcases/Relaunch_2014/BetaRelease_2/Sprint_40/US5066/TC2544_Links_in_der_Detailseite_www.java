 ...
 * @author M.Forster
 */
public class TC2544_Links_in_der_Detailseite_www extends GenericTest_New {
    ...
    private final String searchString = "www*";
    private final String pathToContent = ".//*[@id='article-content_contentwrapper']//*[contains(@href,'www')]";
    ...
    public static void main(String[] args) {
        TC2544_Links_in_der_Detailseite_www test = new TC2544_Links_in_der_Detailseite_www();
        test.before();
        test.runTest();
        test.after();
    }

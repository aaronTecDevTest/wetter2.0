 ...
 * @author M.Forster
 */
public class TC2542_Links_in_der_Detailseite_https extends GenericTest_New {
    ...
    private final String searchString = "https";
    ...
    public static void main(String[] args) {
        TC2542_Links_in_der_Detailseite_https test = new TC2542_Links_in_der_Detailseite_https();
        test.before();
        test.runTest();
        test.after();
    }

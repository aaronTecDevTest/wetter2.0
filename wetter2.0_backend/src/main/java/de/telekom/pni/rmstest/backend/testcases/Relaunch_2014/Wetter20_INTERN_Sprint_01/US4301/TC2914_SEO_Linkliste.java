 ...
 * @author a.kutekidila
 */
public class TC2914_SEO_Linkliste extends GenericTest_New {
     ...
     */
    @Override
    //TODO die überschrift in SEOLINK testen!!!!
    public void runTest() {
    ...
    public static void main(String[] args) {
        TC2914_SEO_Linkliste test = new TC2914_SEO_Linkliste();
        test.before();
        test.runTest();
        test.after();
    }

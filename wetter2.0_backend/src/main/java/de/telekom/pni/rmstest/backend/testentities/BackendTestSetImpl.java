...
/**
 * Die Klasse BackendTestSetImpl.java wird im Backend des Frameworks für die Verwaltung
 ...
 * @author M.Forster
 */
public class BackendTestSetImpl implements TestSet {

    private static final Logger log = Logger.getLogger(BackendTestSetImpl.class);
     ...
     */
    public BackendTestSetImpl(String testSetName, Integer id) {
        log.debug("Creating BackendTestSetImpl-Object");
        this.testSetName = testSetName;
        this.testSetID = id;
        this.testCases = new Vector<TestCase>();
        log.debug("BackendTestSetImpl-Object created");
    }

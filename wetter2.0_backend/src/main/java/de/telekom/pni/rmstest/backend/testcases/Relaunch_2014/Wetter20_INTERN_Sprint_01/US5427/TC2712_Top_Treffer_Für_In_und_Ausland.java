...
/*
 * Prüft, ob die in- und ausländische Top-Treffer-Orte ausgespielt wird.
 */
public class TC2712_Top_Treffer_Für_In_und_Ausland extends GenericTest_New {
    ...
    public static void main(String[] args) {
        TC2712_Top_Treffer_Für_In_und_Ausland test = new TC2712_Top_Treffer_Für_In_und_Ausland();
        test.before();
        test.runTest();
        test.after();
    }

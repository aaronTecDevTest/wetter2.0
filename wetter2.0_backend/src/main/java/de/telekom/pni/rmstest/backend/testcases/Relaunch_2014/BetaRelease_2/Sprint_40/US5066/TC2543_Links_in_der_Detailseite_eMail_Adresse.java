 ...
 * @author M.Forster
 */
public class TC2543_Links_in_der_Detailseite_eMail_Adresse extends GenericTest_New {
    ...
    private final String searchString = "dpa.com";
    ...
    public void checkSearchResult(String pathToSearchResult, String searchString) {
        ...
        try {
            if (pathToSearchResult != null & searchString != null) {
                ...
                if (!content.getAttribute(expectedAttribute).isEmpty() && content.getAttribute(expectedAttribute).contains("mailto:")) {
    ...
    public static void main(String[] args) {
        TC2543_Links_in_der_Detailseite_eMail_Adresse test = new TC2543_Links_in_der_Detailseite_eMail_Adresse();
        test.before();
        test.runTest();
        test.after();
    }

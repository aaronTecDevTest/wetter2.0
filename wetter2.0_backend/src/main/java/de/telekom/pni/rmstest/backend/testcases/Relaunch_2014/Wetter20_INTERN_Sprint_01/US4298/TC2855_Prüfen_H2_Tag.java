 ...
 * @author a.kutekidila
 */
public class TC2855_Prüfen_H2_Tag extends GenericTest_New {
    ...
    public void runTest() {
        ...
        globalVar.resultStringList.add("Wettervorhersage für Darmstadt bei wetter.info");
        globalVar.resultStringList.add("Wettervorhersage für Darmstadt bei wetter.info");
        globalVar.resultStringList.add("Wettervorhersage für Darmstadt bei wetter.info");
        globalVar.resultStringList.add("Wettervorhersage für Darmstadt bei wetter.info");
        globalVar.resultStringList.add("Wettervorhersage für Darmstadt bei wetter.info)");
    ...
    public boolean checkH2Tag(WebElement we) {
        boolean check = false;
    ...
    public static void main(String[] args) {
        TC2855_Prüfen_H2_Tag test = new TC2855_Prüfen_H2_Tag();
        test.before();
        test.runTest();
        test.after();

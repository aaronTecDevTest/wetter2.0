...
public class SelendroidAppOnTwoDeviceWithGeneric extends GenericTest_New {
    ...
    public static void main(String[] args) {
        SelendroidAppOnTwoDeviceWithGeneric test = new SelendroidAppOnTwoDeviceWithGeneric();
        test.before();
        test.runTest();
        test.after();
    }
